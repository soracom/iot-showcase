...
すでにアカウントをお持ちの方は「2. SORACOM LTE-M Button を AWS IoT 1-Click に登録し、メールを送ってみよう！」にお進みください。


<h3 id="content2">2. SORACOM LTE-M Button を AWS IoT 1-Click に登録し、メールを送ってみよう！</h3>
